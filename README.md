...
Здесь студенты могут делиться своими карточками, ставить лайки друг другу за наиболее понравившуюся картинку.

В данном проекте применены такие технологии как html, css, javascript, React, Babel, webpack и GIT.
...
Весь проект расположен на удаленном репозитории github (ссылка на проект: https://dreem13.github.io/react-mesto-auth/).
